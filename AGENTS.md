...
- Local app state persists to `~/.local/share/SignalX/` on Linux (e.g. `commerce/products.json`, `ivr/menus.json`, `threads/`, `contacts/`), **not** the macOS `~/Library/Application Support/SignalX` path in the docs.
